...
4. **Automatic Commit**:
    ...
    *   **Commit Message**: Follow the Conventional Commits format as specified in the `git-commit-v2` skill.
...
- **Coding Style**: If the task involves implementing or modifying code, you **MUST** first call `activate_skill("coding-style-v2")` to load the mandatory coding standards and architectural patterns for the relevant programming language(s).
